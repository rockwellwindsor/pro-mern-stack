  ...
  render() {
    return (
      <div>
        ...
        <button className="btn btn-warning" onClick={this.resetFilter} disabled={!this.state.changed}>Reset</button>
        <button className="btn btn-primary" onClick={this.clearFilter}>Clear filter</button>
      </div>
    );
  }
}
